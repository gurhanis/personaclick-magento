 ...
 */
namespace Personaclick\Personalization\Block\Frontend\Widget;
...
class Recommendation extends \Magento\Framework\View\Element\Template implements \Magento\Widget\Block\BlockInterface {
    ...
    public function __construct(
        ...
        \Personaclick\Personalization\Model\Config\Source\Product\Manufacturer $brand,
        array $data = []
    )
    {
    ...
    public function _toHtml()
    {
        if ($this->_config->isPersonaclickEnabled()) {
            ...
            $this->setTemplate('widget/personaclick.phtml');
